...
public class SucGoodsCtrl {
	...
	PageInfo<UserGoodsRo> list(final SucGoodsMo mo, @RequestParam(value = "pageNum", required = false) Integer pageNum,
	 ...
	 * 查询商品信息
	 */
	@GetMapping("/suc/goods/list-goods")
	List<SucGoodsMo> listGoods(final SucGoodsMo mo) {
		log.info("查询商品信息: {}", mo);
		return svc.list(mo);
	}
