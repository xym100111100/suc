...
public class SucNoticeCtrl {
    ...
    PageInfo<SucNoticeMo> list(final SucNoticeMo mo, @RequestParam(value = "pageNum", required = false) Integer pageNum, @RequestParam(value = "pageSize", required = false) Integer pageSize) {
        ...
        final PageInfo<SucNoticeMo> result = svc.list(mo, pageNum, pageSize);
