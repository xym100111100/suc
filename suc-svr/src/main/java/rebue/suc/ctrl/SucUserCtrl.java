...
public class SucUserCtrl {
     ...
     */
    @GetMapping("/suc/user")
    PageInfo<SucUserMo> list(final SucUserMo mo, @RequestParam(value = "pageNum", required = false) Integer pageNum, @RequestParam(value = "pageSize", required = false) Integer pageSize) {
