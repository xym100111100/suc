...
import rebue.suc.mapper.SucGoodsImgMapper;
...
@Service
@Slf4j
public class SucGoodsImgSvcImpl extends BaseSvcImpl<java.lang.Long, SucGoodsImgJo, SucGoodsImgDao, SucGoodsImgMo, SucGoodsImgMapper> implements SucGoodsImgSvc {
    ...
    public int add(SucGoodsImgMo mo) {
        log.info("sucGoodsImgSvc.add: 添加商品图片 mo-", mo);
        // 如果id为空那么自动生成分布式id
